package kr.hs.entrydsm.entry_freshman.domain.post.web;

import kr.hs.entrydsm.entry_freshman.domain.post.service.CreatePostService;
import kr.hs.entrydsm.entry_freshman.domain.post.service.DeletePostService;
import kr.hs.entrydsm.entry_freshman.domain.post.service.PostDetailsService;
import kr.hs.entrydsm.entry_freshman.domain.post.service.PostListService;
import kr.hs.entrydsm.entry_freshman.domain.post.service.UpdatePostService;
...
import kr.hs.entrydsm.entry_freshman.domain.post.web.dto.response.PostDetailsResponse;
import kr.hs.entrydsm.entry_freshman.domain.post.web.dto.response.PostListResponse;
